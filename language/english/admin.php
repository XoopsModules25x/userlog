...
define('_AM_USERLOG_TEXT_FORM',
       "Enter one exact '%1\$s' or part of '%2\$s' to show all logs for users have that (with prefix '!' have not that). You can enter several separated with comma, e.g.: TERM1, !TERM2, TERM3 means all logs have TERM1 and TERM3, but have not TERM2.");
// Translators: do not touch below for now
// START DO NOT TOUCH
